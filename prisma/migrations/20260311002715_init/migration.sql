...
-- CreateEnum
CREATE TYPE "TournamentStatus" AS ENUM ('UPCOMING', 'GROUP_STAGE', 'KNOCKOUT', 'FINISHED');

-- CreateEnum
CREATE TYPE "MatchStatus" AS ENUM ('SCHEDULED', 'LIVE', 'FINISHED', 'CANCELLED');

-- CreateEnum
CREATE TYPE "EventType" AS ENUM ('TOURNAMENT', 'CONCERT', 'GAME', 'SHOWCASE', 'CEREMONY', 'OTHER');
...
CREATE TABLE "Team" (
    ...
    "logoUrl" TEXT,
    "color" TEXT NOT NULL DEFAULT '#bc2a24',
