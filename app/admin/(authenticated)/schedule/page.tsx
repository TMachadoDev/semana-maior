...
export default function AdminSchedulePage() {
  ...
  useEffect(() => {
    Promise.all([fetchEvents(), fetchSchools()]).finally(() => setLoading(false))
  }, [])
  ...
  const openEdit = (event: any) => {
    ...
    setForm({ 
      ...
      venue: event.venue || '', 
      day: event.day,
      schoolId: event.schoolId || (schools.length > 0 ? schools[0].id : '')
    })
    setShowModal(true)
  }
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="p-6 space-y-4">
                ...
                <div>
                  <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest block mb-1.5">Escola</label>
                  <select
                    value={form.schoolId}
